...
public class snake extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MainActivity.Url = "api.heclouds.com/cmds?device_id=38329359";
        ...
        stop.setOnTouchListener(mImageViewTouchHandler);
    ...
    public ImageView.OnTouchListener mImageViewTouchHandler = new ImageView.OnTouchListener() {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    public void run() {
                        ...
                        if (MainActivity.Pattern % 2 == 0) {
                            if (MainActivity.mySocketServer.flag == false) {
                                ...
                                switch (id) {
                                    case R.id.go:
                                        MainActivity.mySocketServer.send_b(new byte[]{(byte) 0xaa, (byte) 0x03, (byte) 0x0a, (byte) 0x01, (byte) 0x2a});
                                        state_s = "前进";
                                        phHandler.sendEmptyMessage(1);
                                        break;
                                    case R.id.left:
                                        ...
                                        phHandler.sendEmptyMessage(1);
                                        while(longClicked) {
                                            MainActivity.mySocketServer.send_b(new byte[]{(byte) 0xaa, (byte) 0x03, (byte) 0x0a, (byte) 0x02, (byte) 0x2a});
                                            MainActivity.delay(100);
                                        }
                                        break;
                                    case R.id.right:
                                        state_s = "右转";
                                        phHandler.sendEmptyMessage(1);
                                        while(longClicked) {
                                            MainActivity.mySocketServer.send_b(new byte[]{(byte) 0xaa, (byte) 0x03, (byte) 0x0a, (byte) 0x03, (byte) 0x2a});
                                            MainActivity.delay(100);
                                        }
                                        break;
                                    case R.id.stop:
                                        MainActivity.mySocketServer.send_b(new byte[]{(byte) 0xaa, (byte) 0x03, (byte) 0x0a, (byte) 0x04, (byte) 0x2a});
                                        state_s = "停止";
                                        phHandler.sendEmptyMessage(1);
                                        break;
                                }
                            ...
                            switch (id) {
                                case R.id.go:
                                    state_s = post1("http://api.heclouds.com/cmds?device_id=38329359", "1111");
                                    phHandler.sendEmptyMessage(1);
                                    break;
                                case R.id.left:
                                    state_s = post1("http://api.heclouds.com/cmds?device_id=38329359", "2111");
                                    phHandler.sendEmptyMessage(1);
                                    break;
                                case R.id.right:
                                    state_s = post1("http://api.heclouds.com/cmds?device_id=38329359", "3111");
                                    phHandler.sendEmptyMessage(1);
                                    break;
                                case R.id.stop:
                                    state_s = post1("http://api.heclouds.com/cmds?device_id=38329359", "1111");
                ...
                longClicked = false;
                if (MainActivity.Pattern % 2 == 1)
                    if (id != R.id.go && id != R.id.stop)
                        state_s = post1("http://api.heclouds.com/cmds?device_id=38329359", "5111");
                state_s = "停止";
                phHandler.sendEmptyMessage(1);
