...
public class sack extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sack_activity);
        MainActivity.Url = "api.heclouds.com/cmds?device_id=38606722";
...
//        initVideoView();
                        ...
                        while (longClicked) {
                            if (MainActivity.Pattern % 2 == 0) {
                                if (MainActivity.mySocketServer.flag == false) {
                                    ...
                                    switch (id) {
                                        case R.id.go:
                                            MainActivity.mySocketServer.send("1111");
                                            break;
                                        case R.id.left:
                                            MainActivity.mySocketServer.send("2111");
                                            break;
                                        case R.id.right:
                                            MainActivity.mySocketServer.send("3111");
                                            break;
                                        case R.id.back:
                                            MainActivity.mySocketServer.send("4111");
                                            break;
                                    }
                            } else {
                                switch (id) {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.Return:
                Intent intent = new Intent(sack.this, MainActivity.class);
