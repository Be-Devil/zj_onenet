...
public class mouse extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MainActivity.Url = "api.heclouds.com/cmds?device_id=38329347";
    ...
    public ImageView.OnTouchListener mImageViewTouchHandler = new ImageView.OnTouchListener() {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    public void run() {
                        ...
                        if (MainActivity.Pattern % 2 == 0) {
                            if (MainActivity.mySocketServer.flag == false) {
                                ...
                                switch (id) {
                                    case R.id.go:
                                        MainActivity.mySocketServer.send_b(new byte[]{(byte) 0xaa, (byte) 0x03, (byte) 0x09, (byte) 0x01, (byte) 0x2a});
                                        state_s = "前进";
                                        phHandler.sendEmptyMessage(1);
                                        break;
                                    case R.id.left:
                                        MainActivity.mySocketServer.send_b(new byte[]{(byte) 0xaa, (byte) 0x03, (byte) 0x09, (byte) 0x02, (byte) 0x2a});
                                        state_s = "左转";
                                        phHandler.sendEmptyMessage(1);
                                        break;
                                    case R.id.right:
                                        MainActivity.mySocketServer.send_b(new byte[]{(byte) 0xaa, (byte) 0x03, (byte) 0x09, (byte) 0x03, (byte) 0x2a});
                                        state_s = "右转";
                                        phHandler.sendEmptyMessage(1);
                                        break;
                                    case R.id.back:
                                        MainActivity.mySocketServer.send_b(new byte[]{(byte) 0xaa, (byte) 0x03, (byte) 0x09, (byte) 0x04, (byte) 0x2a});
                                        state_s = "后退";
                                        phHandler.sendEmptyMessage(1);
                                        break;
                                }
                ...
                if (MainActivity.Pattern % 2 == 0)
                    MainActivity.mySocketServer.send_b(new byte[]{(byte) 0xaa, (byte) 0x03, (byte) 0x09, (byte) 0x05, (byte) 0x2a});
                else
