...
public class SmartCar extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MainActivity.Url = "api.heclouds.com/cmds?device_id=36494213";
    ...
    public ImageView.OnTouchListener mImageViewTouchHandler = new ImageView.OnTouchListener() {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    public void run() {
                        ...
                        if (MainActivity.Pattern % 2 == 0) {
                            if (MainActivity.mySocketServer.flag == false) {
                                ...
                                switch (id) {
                                    case R.id.go:
                                        MainActivity.mySocketServer.send_b(new byte[]{(byte) 0xaa, (byte) 0x03, (byte) 0x0c, (byte) 0x01, (byte) 0x2a});
                                        state_s = "前进";
                                        phHandler.sendEmptyMessage(1);
                                        break;
                                    case R.id.left:
                                        MainActivity.mySocketServer.send_b(new byte[]{(byte) 0xaa, (byte) 0x03, (byte) 0x0c, (byte) 0x02, (byte) 0x2a});
                                        state_s = "左转";
                                        phHandler.sendEmptyMessage(1);
                                        break;
                                    case R.id.right:
                                        MainActivity.mySocketServer.send_b(new byte[]{(byte) 0xaa, (byte) 0x03, (byte) 0x0c, (byte) 0x03, (byte) 0x2a});
                                        state_s = "右转";
                                        phHandler.sendEmptyMessage(1);
                                        break;
                                    case R.id.back:
                                        MainActivity.mySocketServer.send_b(new byte[]{(byte) 0xaa, (byte) 0x03, (byte) 0x0c, (byte) 0x04, (byte) 0x2a});
                                        state_s = "后退";
                                        phHandler.sendEmptyMessage(1);
                                        break;
                                }
                            ...
                            switch (id) {
                                case R.id.go:
                                    state_s = post1("http://api.heclouds.com/cmds?device_id=36494213", "1111");
                                    phHandler.sendEmptyMessage(1);
                                    break;
                                case R.id.left:
                                    state_s = post1("http://api.heclouds.com/cmds?device_id=36494213", "2111");
                                    phHandler.sendEmptyMessage(1);
                                    break;
                                case R.id.right:
                                    state_s = post1("http://api.heclouds.com/cmds?device_id=36494213", "3111");
                                    phHandler.sendEmptyMessage(1);
                                    break;
                                case R.id.back:
                                    state_s = post1("http://api.heclouds.com/cmds?device_id=36494213", "4111");
                                    phHandler.sendEmptyMessage(1);
                                    break;
                            }
                ...
                if (MainActivity.Pattern % 2 == 0)
                    MainActivity.mySocketServer.send_b(new byte[]{(byte) 0xaa, (byte) 0x03, (byte) 0x0c, (byte) 0x05, (byte) 0x2a});
                else
                    state_s = post1("http://api.heclouds.com/cmds?device_id=36494213", "5111");
                state_s = "停止";
                phHandler.sendEmptyMessage(1);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.Return:
                Intent intent = new Intent(SmartCar.this, MainActivity.class);
